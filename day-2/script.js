...
function partThreeB () {
  ...
  if(color === "pink") {
    ...
    messageParagraph.innerHTML = `Are you feeling loved?`;
  // 3. check for the next color
} else if(color === "red") {
    // 4. give the message for the next color
    messageParagraph.innerHTML = `Are you having a bad day?`;
  } else {
  // 5. otherwise, ask for another color
  messageParagraph.innerHTML = `Try another color.`;
}
...
//There are 6 options to choose from out of 9, the other 3 would be a tie.