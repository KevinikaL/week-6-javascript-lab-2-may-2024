...
function partOneB() {
  ...
  tip = billNumber * 0.2;
  // 4. set the message
  messageParagraph.innerHTML = `Your total is ${bill}. Your tip of ${tip} is at 20%.`;
}
...
function partTwoB() {
  alert("Try it!");
  // 1. prompt for the bill
  bill = prompt("What is your total?");
  // 2. convert it to number
  billNumber = Number(bill);
  // 3. calculate split bill
  split = billNumber / 4;
  // 4. set the message
  messageParagraph.innerHTML = `Your total is ${bill}. Your part of the bill is ${split} amongst 4 guests.`;
}
